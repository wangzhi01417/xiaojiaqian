...
class IndexAction extends Action{
	...
	public function setconf(){
		...
		$this->assign('db_pwd', '');
		$this->assign('db_name', 'xiaojiaqian');
		$this->assign('db_prefix', 'xjq_');
		$this->assign('user_name', 'xiaojiaqian');
		$this->assign('password', '123456');
		$this->assign('repassword', '123456');
		$this->assign('email', 'admin@xiaojiaqian.com');
